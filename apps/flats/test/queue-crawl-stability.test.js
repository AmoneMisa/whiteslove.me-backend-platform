...
const queuePlan = readFileSync(new URL('../src/scheduling/queuePlan.js', import.meta.url), 'utf8');
const queueTasks = readFileSync(new URL('../src/scheduling/queueTasks.js', import.meta.url), 'utf8');
...
const customQueue = readFileSync(new URL('../src/sources/custom-source-queue.js', import.meta.url), 'utf8');
const listingRoutes = readFileSync(new URL('../src/routes/listing-routes.js', import.meta.url), 'utf8');
const listingItemRoutes = readFileSync(new URL('../src/routes/listing-item-routes.js', import.meta.url), 'utf8');
const queueMigration = readFileSync(new URL('../migrations/002_crawl_tasks.sql', import.meta.url), 'utf8');
const scheduler = readFileSync(new URL('../src/scheduling/scheduler.js', import.meta.url), 'utf8');
