...
const facade = readFileSync(new URL('../server/utils/hiringSources.ts', import.meta.url), 'utf8')
...
test('Telegram hiring runtime lives in the hiring source layer', () => {
  assert.match(facade, /Compatibility facade/u)
  assert.doesNotMatch(facade, /async function fetchWorkerPage/u)
